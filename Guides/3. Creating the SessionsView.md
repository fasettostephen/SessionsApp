...
> Previous step [**Guide 2: Creating the model and the data source**](2. Creating the model and the data source.md)


## Guide 3. Creating the SessionsView

* [Creating the Xaml page](#create-the-xaml-page)
* [Creating the Header](#create-the-header)
	* [Defining the Images for each platform](#defining-the-images-for-each-platform)
* [Creating the Listview](#create-the-listview)
* [Creating the ItemTemplate](#create-the-itemtemplate)
* [Creating the menu for each Session](#create-the-menu-for-each-session)
...
> In this case, you will not use MVVM pattern, which is extremely recommended in real projects. To keep it simple the code behind will have the behavior used by the the UI that in a MVVM pattern is defined in the ViewModel.
...
> Next step [**Guide 4: Creating the SessionDetailsView**](4. Creating the SessionDetailsView.md)
