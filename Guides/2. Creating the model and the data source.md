...
> Previous step [**Guide 1: Creating a Xamarin Forms project**](1. Creating a Xamarin Forms project.md)


## Guide 2. Creating the model and the data source
...
> Next step [**Guide 3: Creating the SessionsView**](3. Creating the SessionsView.md)
