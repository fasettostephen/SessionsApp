...
> Previous step [**Guide 5: Adding ShareService**](5. Adding ShareService.md)

### Guide 6. Adding splash screen, name and version

* [Defining the splash screen](#defining-the-splash-screen)
* [Defining the name and the version for each platform](#defining-the-name-and-the-version-for-each-platform)
...
> Next step [**Guide 7: Adding support for WinRT Apps**](7. Adding support for WinRT Apps.md)
